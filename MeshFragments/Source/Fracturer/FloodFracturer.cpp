...
namespace fracturer {
    ...
    /** Private helper function to initialize compute shaders */
    void _initShaderProgram(opengl::ShaderProgram& shaderProgram, const std::string& shaderSource) {
    ...
    void FloodFracturer::build(vox::Space &space, const std::vector<glm::uvec4>& seeds) {
        space.homogenize();
