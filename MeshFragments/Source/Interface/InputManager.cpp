...
const int InputManager::RESET_KEY = GLFW_KEY_M;
...
InputManager::InputManager() :
	_lastCursorPosition(CURSOR_POS), _leftClickPressed(false), _leftRepaints(1), _rightClickPressed(false), _movementsInARow(NUM_MOVEMENT_TYPES), _window(nullptr)
{
}
